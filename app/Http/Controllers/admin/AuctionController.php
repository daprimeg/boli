            ...
            if ($request->hasFile('csv_path')) {
                ...
                foreach ($rows as $key => $data) {
                    ...
                    $vehicle = Vehicle::create([
                            ...
                            'vehicle_type_id' => $this->cleanForeignKey($data['vehicle_id']),
                            'make_id' => $this->cleanForeignKey($data['make_id'] ?? null),
                            'model_id' => $this->cleanForeignKey($data['model_id'] ?? null),
                            'variant_id' => $this->cleanForeignKey($data['variant_id'] ?? null),
                            'body_type_id' => $this->cleanForeignKey($data['body_id'] ?? null),
                            'year_id' => $this->cleanForeignKey($data['year_id'] ?? null),
                            'color_id' => $this->cleanForeignKey($data['color_id'] ?? null),
                            ...
                            'vat_status' => $data['vat_status'] ?? null,
                            'service_history' => $data['service_history'] ?? null,
                            'number_of_services' => is_numeric($data['no_of_services']) ? (int)$data['no_of_services'] : null,
                            'number_of_stamps' => is_numeric($data['no_of_stamps']) ? (int)$data['no_of_stamps'] : null,
                            'inspection_report' => $data['inspection_report'] ?? null,
                            'other_report_name' => $data['other_report_name'] ?? null,
                            'other_report' => $data['other_report'] ?? null,
