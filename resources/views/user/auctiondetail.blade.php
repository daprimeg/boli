...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
    ...
    <ul class="nav nav-pills flex-column flex-md-row gap-md-0 gap-2">
        <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);">
                <i class="icon-base ti tabler-users icon-sm me-1_5"></i> Auction Detail
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="{{ route('futureauction') }}">
                <i class="icon-base ti tabler-lock icon-sm me-1_5"></i> Future Auction
            </a>
        </li>
    </ul>
    ...
    <div class="d-flex flex-wrap gap-2">
        ...
        <div class="invoice_status">
            <select id="UserRole" class="form-select">
                <option value=""> My Interest </option>
                <option value="Downloaded" class="text-capitalize">Toyota</option>
                <option value="Draft" class="text-capitalize">Suzuki</option>
                <option value="Paid" class="text-capitalize">Raksha</option>
                <option value="Partial Payment" class="text-capitalize">CD 70</option>
                <option value="Past Due" class="text-capitalize">Tri-Cycle</option>
                <option value="Sent" class="text-capitalize">Kia</option>
            </select>
        </div>
    </div>
</div>
                     ...
                     <table class="table table-sm datatable-invoice border-top dataTable dtr-column" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="width: 100%;">
                        ...
                        <thead>
                           <tr>
                              ...
                              <th data-dt-column="1" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc dt-ordering-desc" aria-sort="descending" aria-label="#: Activate to remove sorting" tabindex="0"><span class="dt-column-title" role="button">Auction Name</span><span class="dt-column-order"></span></th>
                              <th data-dt-column="2" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc dt-ordering-desc" aria-sort="descending" aria-label="#: Activate to remove sorting" tabindex="0"><span class="dt-column-title" role="button">Vehicle</span><span class="dt-column-order"></span></th>
                              <th data-dt-column="3" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc" aria-label="Status: Activate to sort" tabindex="0"><span class="dt-column-title" role="button">Auction Date</span><span class="dt-column-order"></span></th>
                              <th data-dt-column="4" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc dt-type-numeric" aria-label="Total: Activate to sort" tabindex="0"><span class="dt-column-title" role="button">Last Bid</span><span class="dt-column-order"></span></th>
                              <th data-dt-column="5" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc" aria-label="Issued Date: Activate to sort" tabindex="0"><span class="dt-column-title" role="button">Auction Type</span><span class="dt-column-order"></span></th>
                              <th data-dt-column="7" rowspan="1" colspan="1" class="dt-orderable-none" aria-label="Actions"><span class="dt-column-title">Alert Status</span><span class="dt-column-order"></span></th>
                           </tr>
                        </thead>
                        <tbody>
                           <tr>
