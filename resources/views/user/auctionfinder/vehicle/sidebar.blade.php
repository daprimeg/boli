        ...
        <div class="row px-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <div class="dropdown ">
                        <button class="btn border dropdown-toggle  text-left py-1 px-2" type="button" style="font-size: 15px;" 
                          id="dataDropdown" data-bs-toggle="dropdown" aria-expanded="false">Data</button>
            ...
            <div class="col-md-3 ml-2">
                <div class="form-group">
                    <div class="dropdown ">
                        <button class="btn border dropdown-toggle  text-left py-1 px-1" type="button"style="font-size: 15px;" id="platformDropdown" 
                        data-bs-toggle="dropdown" aria-expanded="false">Platform</button>
            ...
            <div class="col-md-5 d-flex justify-content-end align-items-center">
                <div class="form-group mb-0">
                    <span class="total_count" style="font-size:15px; margin-right: -15px">15,276</span>
                </div>
            </div>
        </div>
    </form>
