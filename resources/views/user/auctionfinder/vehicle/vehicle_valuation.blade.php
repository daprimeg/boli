                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <div class="form-group">
                                        ...
                                        <!-- Dropdown -->
                                        <div class="dropdown">
                                            <button class="btn dropdown-toggle px-2 py-1" type="button"
                                                id="auctionDropdown" data-bs-toggle="dropdown" aria-expanded="false"
                                                style="background:#0f1c2c; border: 1px solid var(--bs-border-color)">
                                                Compare Auction
                                            </button>

                                            <ul class="dropdown-menu dropdown-menu-dark p-2"
                                                style="min-width: 200px; background-color: #0f1c2c ;border: 1px solid var(--bs-border-color); border-radius: 8px; 
                                ...
                                <div class="col-2 ml-2 ">
                                    <div class="form-group">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark p-2"
                                                style="min-width: 200px; background-color: #0f1c2c; border-radius: 8px; border: 1px solid var(--bs-border-color)">
                                                <li>
                                                    <label class="circle-checkbox">
                                                        <input type="checkbox" checked>
                                                        <span class="circle"></span>
                        ...
                        <div class="col-md-4">
                            <ul style="list-style: none; padding-left: 0px; font-size: 15px;">
                                <li>
                                    ...
                                    <button style="padding: 4px 10px; background: #0d6efd;  border-radius: 4px"> View
                                        Report</button>
                                </li>
                            </ul>
                        </div>
