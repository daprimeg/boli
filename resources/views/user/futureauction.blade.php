...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
    ...
    <ul class="nav nav-pills flex-column flex-md-row gap-md-0 gap-2">
        <li class="nav-item">
            <a class="nav-link" href="{{ route('auctiondetail') }}">
                     ...
                     <table class="table table-sm datatable-invoice border-top dataTable dtr-column" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="width: 100%;">
                        ...
                        <thead>
                           <tr>
                              ...
                              <th data-dt-column="3" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc" aria-label="Status: Activate to sort" tabindex="0"><span class="dt-column-title" role="button">Cap Average</span><span class="dt-column-order"></span></th>
                              <th data-dt-column="4" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc dt-type-numeric" aria-label="Total: Activate to sort" tabindex="0"><span class="dt-column-title" role="button">Cap Below</span><span class="dt-column-order"></span></th>
                              ...
                              <th data-dt-column="6" rowspan="1" colspan="1" class="dt-orderable-none" aria-label="Actions"><span class="dt-column-title">Percentage</span><span class="dt-column-order"></span></th>
