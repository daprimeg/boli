                ...
                <div class="card mb-6">
                    <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-5">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            <img src="{{ Auth::user()->avatar ? asset('/public/uploads/avatar/' . Auth::user()->avatar) : asset('assets/img/avatars/default.png') }}" alt="user image" width="100px" class="d-block h-auto ms-0 ms-sm-6 rounded user-profile-img" />
                        </div>
                                    ...
                                    <ul
                                        ...
                                        <li class="list-inline-item d-flex gap-2 align-items-center">
                                            <i class="icon-base ti tabler-map-pin icon-lg"></i
                                                ><span class="fw-medium">{{ Auth::user()->country }} {{ Auth::user()->townCity }}</span>
                                        </li>
                                        <li class="list-inline-item d-flex gap-2 align-items-center">
                ...
                <div class="card mb-6">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled my-3 py-1">
                            ...
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base ti tabler-crown icon-lg"></i><span class="fw-medium mx-2">Website:</span>
                                <span>{{ Auth::user()->website }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base ti tabler-flag icon-lg"></i><span class="fw-medium mx-2">Business Email:</span>
                                <span>{{ Auth::user()->businessEmail }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-language icon-lg"></i>
                                <span class="fw-medium mx-2">Motor Trade Insurance:</span> <span>{{ Auth::user()->motorTradeInsurance }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-language icon-lg"></i>
                                <span class="fw-medium mx-2">VAT Number:</span> <span>{{ Auth::user()->vatNumber }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-language icon-lg"></i>
                                <span class="fw-medium mx-2">Company Address 1:</span> <span>{{ Auth::user()->companyAddress1 }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-language icon-lg"></i>
                                <span class="fw-medium mx-2">Company Address 1:</span> <span>{{ Auth::user()->companyAddress2 }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-language icon-lg"></i>
                                <span class="fw-medium mx-2">Town City:</span> <span>{{ Auth::user()->townCity }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-language icon-lg"></i>
                                <span class="fw-medium mx-2">Country:</span> <span>{{ Auth::user()->country }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-language icon-lg"></i>
                                <span class="fw-medium mx-2">Postcode / Zip code :</span> <span>{{ Auth::user()->postcode }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-language icon-lg"></i>
                                <span class="fw-medium mx-2">Telephone:</span> <span>{{ Auth::user()->telephone }}</span>
                            </li>
                        </ul>
                        ...
                        <ul class="list-unstyled my-3 py-1">
                            ...
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-mail icon-lg"></i>
                                <span class="fw-medium mx-2">Upload ID:</span>
                        ...
                        <ul class="list-unstyled my-3 py-1">
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-mail icon-lg"></i>
                                    <span class="fw-medium mx-2">Motor Trade Proof:</span>
                            ...
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base ti tabler-mail icon-lg"></i>
                                <span class="fw-medium mx-2">Address Proof:</span>
                                        ...
                                        <span class="timeline-point timeline-point-primary"></span>
                                            <div class="timeline-event">
                                                ...
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    @endif
                                                    <div class="ms-3">
                                                        <p class="mb-0 small fw-medium">{{ $alert->user ? $alert->user->firstName : 'Unknown' }} {{ $alert->user ? $alert->user->surname : '' }}</p>
